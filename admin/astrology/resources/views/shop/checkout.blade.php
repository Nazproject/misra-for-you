				    ...
				    <div class="payment">
				        <div class="che__header" role="tab" id="headingFour">
				          	<a class="collapsed checkout__title" data-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
					            <span>PayPal <img src="{{asset('/shop/images/icons/payment.png') }}" alt="payment images"> </span>
				          	</a>
				        </div>
...
<center><button style="height: 50px; background-color: #f46b41; color: white; font-weight: 600;">Place Order</button></center>
<br>
<br>
